...
{* $Id: piwik_user_main.htm 21 2010-04-21 01:56:44Z hilope $ *}
...
<form action="{$ourEntry|default:'index.php'}" method="get">
    <div>
        ...
        <input type="hidden" name="tpl" value="piwik" />
...
<p><a href="{modurl modname="piwik" type="user" func="main"}" title="Die normalen Statistiken anzeigen">Zur&uuml;ck zu den normalen Statistiken</a></p>

{modurl modname="piwik" type="user" func="main" tpl="piwik" assign="returnurl"}
{modcallhooks hookobject="category" hookaction="display" module="JuFeBostat" returnurl=$returnurl}
</div>
